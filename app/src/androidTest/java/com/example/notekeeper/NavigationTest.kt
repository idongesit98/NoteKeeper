...
@RunWith(AndroidJUnit4::class)
 class NavigationTest{
     @get:Rule @JvmField
     val itemActivity = ActivityScenarioRule(ItemActivity::class.java)
    ...
    fun selectNoteAfterNavigationDrawerChange(){
        ...
        onView( withId(R.id.spinnerCourses)).check(matches(withSpinnerText
            (containsString(note.course?.title))))
